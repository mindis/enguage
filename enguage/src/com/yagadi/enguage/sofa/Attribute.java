...
//	}
	...
	static public String attrTest( String s ) {	return s +" "+ (isAttribute( s ) ? "IS":"is NOT") +" an attribute";}
	static public void main( String argv[]) {
		...
		sa.contract( "=" );
		audit.audit("Sofa.doCall() => sa is "+ sa.toString());
